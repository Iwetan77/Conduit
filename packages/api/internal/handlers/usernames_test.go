...
func TestUsernameRules(t *testing.T) {
	cases := []struct {
		...
		{"underscore inside", "a_1_b", false, "only letters and numbers"},
		{"digits after a letter", "a1b", true, ""},
		{"all digits", "123456", false, "must start with a letter"},
		{"leading digit", "1van", false, "must start with a letter"},
		...
		{"empty", "", false, ""},
		{"leading underscore", "_ivan", false, "must start with a letter"},
		{"trailing underscore", "ivan_", false, "only letters and numbers"},
