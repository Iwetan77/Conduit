      ...
      <AnimatePresence mode="wait">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 rounded-xl bg-brand-green text-brand-black
                           font-bold hover:bg-brand-green/90 transition-colors"
              >
                Send Payment
              </button>
            </div>
        ...
        {step === "pending" && (
          ...
          >
            ...
            <p className="text-brand-white font-medium">Settling on-chain...</p>
          ...
          >
            ...
            <button
              ...
              className="w-full py-3 rounded-xl border border-brand-border
                         text-brand-white hover:border-brand-green/30 transition-colors font-medium"
            >
              Send Another
            </button>
          </motion.div>
        ...
        {step === "error" && (
          ...
          >
            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-5">
              <p className="text-red-400 font-medium mb-2">Transaction Failed</p>
