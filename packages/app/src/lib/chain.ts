// The Arc Testnet chain definition, in its own module.
//
// Split out of lib/wagmi.ts to break an import cycle: the Circle connector
// needs the chain, and lib/wagmi.ts needs the Circle connector to put it in
// the connector list. Everything that already imports these from lib/wagmi
// keeps working — that module re-exports them.
